...
@section('content')
<div id="appRoot" class="relative h-screen bg-slate-50 dark:bg-[#020617] text-slate-800 dark:text-slate-300 font-sans overflow-hidden flex flex-col selection:bg-fuchsia-500/30 selection:text-fuchsia-900 dark:selection:text-white pt-20 transition-colors duration-500">
    ...
    <div class="flex flex-1 overflow-hidden relative" x-data="{ sidebarOpen: false }">
            ...
            <div class="p-6 overflow-y-auto custom-scrollbar flex-1">
                ...
                <nav class="space-y-2">
                    ...
                    <a href="{{ route('developer.info') }}" class="group flex items-center gap-3 px-4 py-3 rounded-xl bg-slate-100 dark:bg-white/10 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white font-bold shadow-sm dark:shadow-[0_0_15px_rgba(255,255,255,0.05)] transition-all hover:scale-[1.02]">
                        <span class="text-fuchsia-600 dark:text-fuchsia-400 group-hover:scale-110 transition text-lg drop-shadow-sm dark:drop-shadow-[0_0_8px_rgba(217,70,239,0.5)]">👨‍💻</span>
                        Informasi
                    </a>
                </nav>
            </div>
        ...
        <main class="flex-1 flex flex-col relative z-10 h-full overflow-y-auto overflow-x-hidden perspective-container custom-scrollbar pb-20">
            ...
            {{-- HEADER CONTENT --}}
            <header class="flex flex-col justify-center px-6 md:px-10 py-6 shrink-0 sticky top-0 z-40 bg-white/80 dark:bg-[#020617]/80 backdrop-blur-xl border-b border-slate-200 dark:border-white/5 transition-colors duration-500">
                <div class="flex items-center justify-between w-full max-w-7xl mx-auto">
                    <div class="flex items-start gap-4">
                        <button @click="sidebarOpen = true" class="lg:hidden p-2 bg-slate-100 dark:bg-white/5 rounded-lg text-slate-700 dark:text-white hover:bg-slate-200 dark:hover:bg-white/10 transition mt-2">
                        ...
                        <div>
                            ...
                            <h2 class="text-slate-900 dark:text-white font-bold text-2xl md:text-3xl tracking-tight transition-colors">Project & Developer Hub</h2>
                            <p class="text-sm text-slate-600 dark:text-white/60 mt-1 transition-colors">Informasi penelitian dan penyusun media.</p>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <div class="flex-1 p-5 md:p-8 lg:p-10 flex items-center justify-center">
                <div class="w-full max-w-6xl grid grid-cols-1 xl:grid-cols-3 gap-6 md:gap-8 reveal">
                    ...
                    <div class="xl:col-span-1 tilt-element glass-card rounded-[2rem] p-6 md:p-8 relative overflow-hidden flex flex-col items-center text-center group border-t-2 border-t-cyan-400 dark:border-t-cyan-500/50 shadow-xl hover:shadow-2xl dark:shadow-2xl dark:shadow-cyan-900/20 transition-colors duration-500">
                        {{-- BG Card --}}
                        <div class="absolute inset-0 bg-gradient-to-b from-cyan-100/50 dark:from-cyan-500/5 to-transparent pointer-events-none transition-colors"></div>
                        <div class="absolute -top-20 -right-20 w-48 h-48 bg-cyan-300/30 dark:bg-cyan-500/20 rounded-full blur-[60px] group-hover:bg-cyan-400/40 dark:group-hover:bg-cyan-500/30 transition duration-700"></div>
                        
                        {{-- Avatar --}}
                        <div class="relative w-32 h-32 md:w-48 md:h-48 mb-8 inner-3d mt-4">
                            <div class="absolute inset-0 rounded-full bg-gradient-to-tr from-cyan-300 to-indigo-400 dark:from-cyan-400 dark:to-indigo-500 animate-spin-slow blur-md opacity-50 group-hover:opacity-100 transition duration-500"></div>
                        ...
                        <a href="mailto:2210131210018@mhs.ulm.ac.id" class="mt-auto w-full inner-3d py-3.5 rounded-xl bg-white dark:bg-[#020617] border border-slate-200 dark:border-white/10 text-slate-600 dark:text-white/60 hover:text-cyan-700 dark:hover:text-white hover:border-cyan-400 dark:hover:border-cyan-500/50 shadow-sm hover:shadow-md dark:hover:shadow-[0_0_20px_rgba(6,182,212,0.2)] flex items-center justify-center gap-2 transition-all group/mail">
                            <svg class="w-4 h-4 text-cyan-600 dark:text-cyan-500 group-hover/mail:-translate-y-0.5 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                    ...
                    <div class="xl:col-span-2 flex flex-col gap-6 md:gap-8 h-full">
                        ...
                        <div class="glass-card rounded-[2rem] p-8 md:p-12 relative overflow-hidden flex-1 flex flex-col justify-center border-l-4 border-l-indigo-400 dark:border-l-indigo-500 shadow-xl dark:shadow-2xl dark:shadow-indigo-900/10 transition-colors duration-500">
                            <div class="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-[0.02] dark:opacity-[0.02]"></div>
                            
                            <div class="relative z-10">
                                <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-200 dark:border-indigo-500/20 text-indigo-700 dark:text-indigo-400 text-[10px] font-bold uppercase tracking-widest mb-6 shadow-sm dark:shadow-inner transition-colors">
                            ...
                            <div class="relative z-10 flex flex-wrap items-center gap-3 mt-10">
                                <span class="px-4 py-2 rounded-xl bg-slate-100 dark:bg-[#020617] border border-slate-200 dark:border-white/10 text-xs font-bold text-slate-700 dark:text-slate-300 flex items-center gap-2 shadow-sm dark:shadow-inner transition-colors"><div class="w-3 h-3 bg-red-500 rounded-sm"></div> Laravel</span>
                                <span class="px-4 py-2 rounded-xl bg-slate-100 dark:bg-[#020617] border border-slate-200 dark:border-white/10 text-xs font-bold text-slate-700 dark:text-slate-300 flex items-center gap-2 shadow-sm dark:shadow-inner transition-colors"><div class="w-3 h-3 bg-cyan-500 dark:bg-cyan-400 rounded-full"></div> Tailwind CSS</span>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                            ...
                            {{-- Card Dosen --}}
                            <div class="glass-card rounded-[2rem] p-8 flex flex-col justify-center relative overflow-hidden transition-colors duration-500 shadow-md dark:shadow-none">
                                ...
                                <div class="space-y-5 relative z-10">
                                    <div class="flex items-start gap-4">
                                        <div class="w-8 h-8 rounded-lg bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/20 text-emerald-600 dark:text-emerald-400 flex items-center justify-center text-sm font-bold shrink-0 shadow-sm dark:shadow-inner transition-colors">1</div>
                                        <p class="text-sm font-bold text-slate-800 dark:text-white/90 leading-tight pt-1.5 transition-colors">Novan Alkaf Bahrain Saputra, S.Kom., M.T.</p>
                                    </div>
                                    <div class="flex items-start gap-4">
                                        <div class="w-8 h-8 rounded-lg bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/20 text-emerald-600 dark:text-emerald-400 flex items-center justify-center text-sm font-bold shrink-0 shadow-sm dark:shadow-inner transition-colors">2</div>
                                        <p class="text-sm font-bold text-slate-800 dark:text-white/90 leading-tight pt-1.5 transition-colors">Muhammad Hifdzi Adini, S.Kom., M.T.</p>
                                    </div>
                                </div>
                            </div>

                            {{-- Card Action --}}
                            <div class="glass-card rounded-[2rem] p-8 flex flex-col items-center justify-center text-center relative overflow-hidden group transition-colors duration-500 shadow-md dark:shadow-none">
                                <div class="absolute inset-0 bg-gradient-to-br from-cyan-400/10 to-indigo-400/10 dark:from-cyan-600/10 dark:to-indigo-600/10 opacity-0 group-hover:opacity-100 transition duration-500"></div>
                                
                                <div class="w-16 h-16 rounded-full bg-white dark:bg-[#020617] border border-slate-200 dark:border-white/10 flex items-center justify-center mb-6 text-cyan-500 dark:text-cyan-400 shadow-md dark:shadow-lg relative z-10 group-hover:scale-110 transition duration-300">
                                ...
                                <h4 class="text-xl font-bold text-slate-900 dark:text-white mb-3 relative z-10 transition-colors">Eksplorasi Media</h4>
                                <p class="text-sm text-slate-600 dark:text-white/50 mb-8 relative z-10 leading-relaxed max-w-xs transition-colors">Lihat hasil implementasi langsung dari media pembelajaran Tailwind CSS ini.</p>
                                
                                <a href="https://utilwind.research-media.web.id/" target="_blank" class="w-full relative z-10 inline-flex items-center justify-center gap-3 px-6 py-4 rounded-xl bg-cyan-500 hover:bg-cyan-600 dark:hover:bg-cyan-400 text-white dark:text-[#020617] font-black text-sm uppercase tracking-wider transition-all shadow-lg dark:shadow-[0_0_30px_rgba(6,182,212,0.4)] hover:scale-105 active:scale-95">
...
<style>
    ...
    .dark .glass-card { background: rgba(10, 14, 23, 0.7); border: 1px solid rgba(255, 255, 255, 0.08); box-shadow: 0 4px 30px rgba(0, 0, 0, 0.2); }
