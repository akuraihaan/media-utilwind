...
@section('title','Bayangan dan Efek Visual')
        ...
        <main id="mainScroll" class="flex-1 h-full overflow-y-auto scroll-smooth relative bg-transparent custom-scrollbar scroll-padding-top-24">
            <div id="stickyHeader" class="sticky top-0 z-30 w-full backdrop-blur-2xl border-b border-adaptive px-4 md:px-8 py-4 flex items-center justify-between transition-colors duration-500" style="background-color: var(--glass-header);">
                <div class="flex items-center gap-4 min-w-0">
                    <div class="w-8 h-8 rounded-lg bg-indigo-500/10 dark:bg-indigo-500/20 border border-indigo-500/20 flex items-center justify-center font-bold text-xs text-indigo-600 dark:text-indigo-400 shrink-0">3.4</div>
                    <div class="min-w-0">
                        <h1 class="text-sm font-bold text-heading line-clamp-1 transition-colors">Bayangan dan Efek Visual</h1>
                        <p class="text-[10px] text-muted line-clamp-1 transition-colors">Border, radius, shadow, dan komposisi kartu</p>
                    </div>
                </div>
            ...
            <div class="p-4 sm:p-6 lg:p-16 max-w-5xl mx-auto pb-40">
                <div class="mb-16 md:mb-24">
                    <div class="card-adaptive rounded-3xl border p-6 md:p-8 overflow-hidden relative mb-10">
                        ...
                        <p class="text-xs font-mono font-bold text-indigo-600 dark:text-indigo-400 uppercase tracking-[.25em] mb-3">Subbab 3.4</p>
                        <h2 class="text-3xl md:text-5xl font-black text-heading leading-tight mb-4">Bayangan dan Efek Visual</h2>
                        <p class="text-sm md:text-base text-muted leading-relaxed max-w-3xl text-justify">
                            Pada subbab ini, pembelajar mempelajari efek visual dasar pada komponen web, yaitu garis tepi, sudut melengkung, dan bayangan. Ketiga bagian ini membuat kartu, tombol, kotak informasi, dan panel konten lebih jelas, rapi, serta mudah dibedakan dari latar halaman.
                        </p>
                    </div>
                ...
                <article class="space-y-24 md:space-y-32">
                    <section id="section-61" class="lesson-section scroll-mt-32" data-lesson-id="61">
                        <div class="space-y-8 md:space-y-10">
                            <div class="space-y-4 border-l-4 border-indigo-500 pl-4 md:pl-6">
                                <span class="text-indigo-600 dark:text-indigo-400 font-mono text-xs uppercase tracking-widest">Lesson 3.4.1</span>
                    ...
                    <section id="section-62" class="lesson-section scroll-mt-32" data-lesson-id="62">
                        <div class="space-y-8 md:space-y-10">
                            <div class="space-y-4 border-l-4 border-purple-500 pl-4 md:pl-6">
                                <span class="text-purple-600 dark:text-purple-400 font-mono text-xs uppercase tracking-widest">Lesson 3.4.2</span>
                    ...
                    <section id="section-63" class="lesson-section scroll-mt-32" data-lesson-id="63">
                        <div class="space-y-8 md:space-y-10">
                            <div class="space-y-4 border-l-4 border-pink-500 pl-4 md:pl-6">
                                <span class="text-pink-600 dark:text-pink-400 font-mono text-xs uppercase tracking-widest">Lesson 3.4.3</span>
                    ...
                    <section id="section-64" class="lesson-section scroll-mt-32" data-lesson-id="64">
                        <div class="space-y-8 md:space-y-10">
                            <div class="space-y-4 border-l-4 border-emerald-500 pl-4 md:pl-6">
                                <span class="text-emerald-600 dark:text-emerald-400 font-mono text-xs uppercase tracking-widest">Lesson 3.4.4</span>
                    ...
                    <section id="section-65" class="lesson-section scroll-mt-32 pt-10 border-t border-adaptive" data-lesson-id="65" data-type="activity">
                ...
                <div class="mt-20 md:mt-32 pt-8 border-t border-adaptive flex flex-col sm:flex-row justify-between items-center gap-4 transition-colors">
                    <a href="{{ \Illuminate\Support\Facades\Route::has('courses.borders') ? route('courses.borders') : '#' }}" class="group flex items-center gap-4 text-muted hover:text-heading transition-colors w-full sm:w-auto justify-center sm:justify-start">
                        ...
                        <div class="text-left"><div class="text-[10px] uppercase tracking-widest font-bold opacity-60">Sebelumnya</div><div class="font-black text-xs md:text-sm line-clamp-1">Border dan Radius</div></div>
                    </a>
...
<script>
    window.LESSON_IDS = [61,62,63,64,65];
