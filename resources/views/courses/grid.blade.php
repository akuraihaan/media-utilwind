...
<button id="mobileSidebarToggle" class="lg:hidden fixed bottom-6 right-6 z-50 p-4 rounded-full shadow-2xl bg-cyan-600 text-white hover:bg-cyan-500 focus:outline-none transition-transform hover:scale-110">
