...
<div class="relative min-h-screen flex items-center justify-center bg-[#020617] text-slate-200 font-sans overflow-hidden selection:bg-cyan-500/30 selection:text-white p-6">
    ...
    <div class="w-full max-w-[500px] relative z-20 animate-fade-in-up">
        ...
        <div class="absolute -top-20 -right-20 w-40 h-40 bg-cyan-500/20 rounded-full blur-[60px] animate-pulse"></div>
        <div class="absolute -bottom-20 -left-20 w-40 h-40 bg-purple-500/20 rounded-full blur-[60px] animate-pulse" style="animation-delay: 1s;"></div>
        ...
        <div class="relative bg-[#0f141e]/70 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10 shadow-2xl shadow-black/50 overflow-hidden group">
            ...
            <div class="text-center mb-8">
                <a href="{{ url('/') }}" class="inline-flex items-center gap-3 mb-6 group cursor-pointer transition-transform hover:scale-105">
                    
                </a>
                
                <h1 class="text-2xl font-black text-white mb-2">Buat Akun Baru</h1>
                <p class="text-white/50 text-sm">Mulai perjalanan belajar Anda sekarang.</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <div class="group/input">
                    <label class="block text-xs font-bold text-white/60 uppercase tracking-wider mb-2 ml-1 group-focus-within/input:text-cyan-400 transition-colors">Nama Lengkap</label>
                    <div class="relative">
                ...
                <div class="group/input">
                    <label class="block text-xs font-bold text-white/60 uppercase tracking-wider mb-2 ml-1 group-focus-within/input:text-cyan-400 transition-colors">Password</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <svg class="h-5 w-5 text-white/30 group-focus-within/input:text-cyan-400 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <button type="submit"
                    class="relative w-full py-4 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 font-bold text-white shadow-lg shadow-cyan-900/30 hover:shadow-cyan-900/50 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 overflow-hidden group/btn mt-2">
            ...
            <div class="mt-8 text-center border-t border-white/5 pt-6">
                <p class="text-sm text-white/40">
                    Sudah punya akun?
                    <a href="{{ route('login') }}" class="text-fuchsia-400 font-bold hover:text-fuchsia-300 hover:underline decoration-2 underline-offset-4 transition-all ml-1">
                        Masuk Disini
                    </a>
                </p>
            </div>
