...
<div id="landingRoot" class="relative min-h-screen bg-slate-50 dark:bg-[#020617] text-slate-600 dark:text-slate-300 font-sans overflow-x-hidden selection:bg-fuchsia-500/30 selection:text-fuchsia-900 dark:selection:text-white transition-colors duration-500">
    ...
    {{-- ======================================================================
         1. ATMOSPHERE LAYER (Background Effect)
         ====================================================================== --}}
    <div class="fixed inset-0 -z-50 pointer-events-none">
        {{-- Dynamic Glows (Warna disesuaikan agar lembut di light mode) --}}
        ...
        {{-- Bintang Interaktif (Transparan di Light Mode, Terlihat di Dark Mode) --}}
        ...
        <div class="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div class="text-center lg:text-left relative z-10">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 animate-fade-in-up" style="animation-delay: 0.3s;">
                    @auth
                        <a href="{{ route('courses.curriculum') }}" class="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-gradient-to-r from-fuchsia-600 to-indigo-600 hover:from-fuchsia-500 hover:to-indigo-500 text-white font-bold text-sm md:text-base transition-all shadow-lg dark:shadow-[0_0_30px_rgba(217,70,239,0.3)] hover:scale-105 active:scale-95 flex items-center justify-center gap-2">
                    ...
                    @else
                        <a href="{{ route('register') }}" class="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-slate-900 dark:bg-white hover:bg-slate-800 dark:hover:bg-slate-200 text-white dark:text-[#020617] font-black text-sm md:text-base transition-all shadow-lg dark:shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:scale-105 active:scale-95 flex items-center justify-center">
                            Mulai Koding Gratis
                        </a>
                    @endauth
                    
                    <a href="#fitur" class="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-white/80 dark:bg-[#0f141e]/80 border border-slate-200 dark:border-white/10 text-slate-700 dark:text-white font-bold text-sm md:text-base hover:bg-slate-50 dark:hover:bg-white/10 transition-all flex items-center justify-center gap-2 backdrop-blur-sm group shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                ...
                <div class="group p-8 rounded-[2rem] bg-white dark:bg-[#0f141e] border border-slate-200 dark:border-white/5 hover:border-fuchsia-400 dark:hover:border-fuchsia-500/30 transition-all duration-500 reveal flex flex-col h-full relative overflow-hidden interactive-card shadow-sm hover:shadow-md dark:shadow-none" style="transition-delay: 100ms">
                    ...
                    <div class="relative z-10 flex-1">
                        ...
                        <a href="{{ route('cheatsheet.index') }}" class="text-xs font-bold text-fuchsia-600 dark:text-fuchsia-400 uppercase tracking-widest flex items-center gap-2 group-hover:translate-x-2 transition-transform mt-auto">
                            Buka Kamus &rarr;
                        </a>
                    </div>
                </div>
                ...
                <div class="group p-8 rounded-[2rem] bg-white dark:bg-[#0f141e] border border-slate-200 dark:border-white/5 hover:border-cyan-400 dark:hover:border-cyan-500/30 transition-all duration-500 reveal flex flex-col h-full relative overflow-hidden interactive-card shadow-sm hover:shadow-md dark:shadow-none" style="transition-delay: 200ms">
                    ...
                    <div class="relative z-10 flex-1">
                        ...
                        <a href="{{ route('sandbox') }}" class="text-xs font-bold text-cyan-600 dark:text-cyan-400 uppercase tracking-widest flex items-center gap-2 group-hover:translate-x-2 transition-transform mt-auto">
                            Mulai Koding &rarr;
                        </a>
                    </div>
                </div>
                ...
                <div class="md:col-span-2 group p-8 rounded-[2rem] bg-white dark:bg-[#0f141e] border border-slate-200 dark:border-white/5 hover:border-emerald-400 dark:hover:border-emerald-500/30 transition-all duration-500 reveal flex flex-col md:flex-row items-center gap-8 overflow-hidden relative interactive-card shadow-sm hover:shadow-md dark:shadow-none" style="transition-delay: 300ms">
                    ...
                    <div class="flex-1 relative z-10">
                        ...
                        <a href="{{ route('dashboard') }}" class="text-xs font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-widest flex items-center gap-2 group-hover:translate-x-2 transition-transform">
                            Lihat Dasbor &rarr;
                        </a>
                    </div>
    ...
    <section class="py-24 md:py-32 relative bg-slate-50 dark:bg-[#020617] overflow-hidden border-t border-slate-200 dark:border-white/5 transition-colors duration-500">
        ...
        <div class="max-w-3xl mx-auto px-5 text-center relative z-10 reveal">
            ...
            <a href="{{ route('register') }}" class="inline-flex items-center justify-center gap-2 px-10 py-4 rounded-xl bg-slate-900 dark:bg-white text-white dark:text-[#020617] font-black text-lg hover:bg-slate-800 dark:hover:bg-slate-200 hover:scale-105 active:scale-95 transition-all shadow-xl dark:shadow-[0_0_40px_rgba(255,255,255,0.2)]">
                Daftar Gratis
            </a>
        </div>
    </section>
...
initTheme(); // Eksekusi saat diload
    ...
    if(window.innerWidth > 768) {
        ...
        if(canvas) {
            ...
            function drawParticles() {
                ...
                // Ubah warna bintang menyesuaikan kontras (diset agar lebih masuk akal jika muncul di light mode)
