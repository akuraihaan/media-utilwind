    ...
    <aside class="w-64 bg-[#1e293b] border-r border-white/5 flex flex-col shrink-0 transition-all duration-300">
        ...
        <nav class="flex-1 overflow-y-auto py-6 px-3 space-y-6">
            ...
            <div class="space-y-1">
                ...
                <a href="{{ route('admin.analytics.questions') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg {{ Route::is('admin.analytics.questions') || Route::is('admin.questions.*') ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-500/30' : 'text-gray-400 hover:bg-white/5 hover:text-white' }} transition-all">
